...
The benchmark data is a deterministic private derivative dataset. Public battery-aging ranges and anomaly patterns informed the generator, but hidden evaluation cells and labels are generated by `tools/generate_battery_benchmark.py` and are not public benchmark answers.
